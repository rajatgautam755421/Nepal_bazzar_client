        ...
        >
          ...
          <div className="space-y-2 mt-2">
            ...
            >
              ...
              <option value="US" selected={state === "US" && true}>
                A
              </option>
              <option value="CA" selected={state === "CA" && true}>
                B
              </option>
              <option value="FR" selected={state === "FR" && true}>
                C
              </option>
              <option value="DE" selected={state === "DE" && true}>
                D
              </option>
            </select>
          </div>
